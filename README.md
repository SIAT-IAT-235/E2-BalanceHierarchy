...
|-----------------------------------|--------|---------|---------|---------|---------|-----------|
| **Balance and Hierarchy Sketches (Part 1)** | No sketches submitted or off-topic. | Sketches are incomplete or lack clear design intent. | Sketches demonstrate some understanding of balance and hierarchy but have inconsistencies. | Sketches effectively demonstrate balance and hierarchy principles with minor issues. | Sketches are well-executed and demonstrate a strong understanding of balance and hierarchy. | 40 |
| **Gestalt Principle Sketches (Part 2)** | No Gestalt sketches submitted or irrelevant principles used. | Sketches show minimal understanding of Gestalt principles. | Gestalt principles are used, but their application is not clear or consistent. | Sketches effectively apply Gestalt principles but could improve clarity. | Sketches strongly apply Gestalt principles to enhance information organization. | 40 |
| **Updated HTML and CSS (Part 3)** | No updates made to HTML/CSS. | HTML/CSS updates are incomplete or do not align with the sketch. | HTML/CSS is updated but lacks strong visual hierarchy. | HTML/CSS is well-updated, effectively aligning with the Gestalt sketch. | HTML/CSS fully reflects the Gestalt sketch, demonstrating clear structure and strong hierarchy. | 20 |
